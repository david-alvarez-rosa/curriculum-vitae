...
\cvsection[page1sidebar]{Experience}{\faBriefcase}
...
the technical support of its great human team.%
\divider{}
...
\institution{\href{https://driverless.upc.edu/}{Driverless UPC -- School of
...
of a fully \textbf{autonomous} car.
...
\cvsection[page2sidebar]{Courses}{\faBook}
...
\durationShort{September 2019 -- Present}%
\divider[empty]{}
...
\position{%
  \href{http://david.alvarezrosa.com:5000}{Study Schedule}\footnotemark[7]%
}{60 hours}%
\institution{%
  \href{https://www.upc.edu/en}{Polytechnic University of Catalonia} --
  \href{https://etseib.upc.edu/en}{School of Engineering}%
...
\location{}%
Study schedule generator adapted to student (data analysis).
...
\begin{fullwidth}
  ...
  \begin{minipage}{12cm}
    Created a study schedule generator adapted to students, through
    \textbf{data analysis}: clustering/k-nearest-neighbours. Based on past
    grades, desired performance and schedule restrictions we were able to
    create the best study schedule possible to \textbf{maximize} user
    \textbf{performance}.  Created a study schedule generator adapted to
    students, through \textbf{data analysis}:
    clustering/k-nearest-neighbours. Based on past grades, desired performance
    and schedule restrictions we were able to create the best study schedule
    possible to \textbf{maximize} user \textbf{performance}.
...
Ambitious, hardworking, extrovert, open-minded and reliable leader, with a lot
of initiative and a great capacity to work in group.

Because of my active personality, I have participated in a lot of
extracurricular activities to complement my education, such as voluntary work,
projects and courses.

and received grants from the Spanish Ministry of Education. This wide variety
of scholarships and programs in which I have been immersed make me approach
situations from multiple points of view. Thanks to this ability, I have
developed a good range of personal projects. Some of them have improving
people’s lives around me as a target: HowAreYouTweeting and WearAMask are some
of the examples. For more information about them and other personal projects,
please check the details in the sections below.
